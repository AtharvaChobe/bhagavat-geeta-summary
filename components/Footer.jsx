        ...
        <>
            <footer className="text-white body-font bg-black">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 Atharva Chobe —
                        <a href="https://twitter.com/" className="text-white ml-1" rel="noopener noreferrer" target="_blank">@atharvachobe_04</a>
                    </p>
